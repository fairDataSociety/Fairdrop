      ...
      <div className="content-outer content-fairdrop">
        <div className="content-inner content-fade-in content-fade-out">
          ...
          <div className="content-text">
            ...
            <p>It also comes with a built-in 256-bit ECDSA signature algorithm and the ability to send files of up to 5 MB in size which should increase considerably in the mid-term future.</p>
            ...
            <p>Since Fairdrop is still in its testing phase and for now we can’t guarantee data persistence. So be sure not to use it for any files that you can’t afford to lose. You can also see Fairdrop’s code on <a rel="noopener noreferrer" target="_blank" href="https://github.com/fairDataSociety"><a alt="github logo" src={this.props.appRoot + "/assets/images/github-logo.svg"}/>GitHub</a> or use the library to build your own application on top of the code. It is supported by major browsers like Firefox, Chrome and Brave.</p>
          </div>
        </div>
      </div>
    )

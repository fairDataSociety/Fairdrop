...
ARG REACT_APP_SWARM_GATEWAY
ARG REACT_APP_GETH_GATEWAY
ARG REACT_APP_CHAIN_ID
ARG REACT_APP_DTRANSFER_HOST
ARG REACT_APP_ENS_ADDRESS
ARG REACT_APP_FIFS_REGISTRAR_ADDRESS
ARG REACT_APP_RESOLVER_ADDRESS
ARG REACT_APP_FAUCET_URL
ENV REACT_APP_ENV_NAME=$REACT_APP_ENV_NAME
ENV REACT_APP_DOMAIN_NAME=$REACT_APP_DOMAIN_NAME
ENV REACT_APP_SWARM_GATEWAY=$REACT_APP_SWARM_GATEWAY
ENV REACT_APP_GETH_GATEWAY=$REACT_APP_GETH_GATEWAY
...
ENV REACT_APP_FIFS_REGISTRAR_ADDRESS=$REACT_APP_FIFS_REGISTRAR_ADDRESS
ENV REACT_APP_RESOLVER_ADDRES=$REACT_APP_RESOLVER_ADDRES
ENV REACT_APP_FAUCET_URL=$REACT_APP_FAUCET_URL
